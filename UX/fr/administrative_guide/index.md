...
## Licence Compositeur Digital UX

Compositeur Digital UX offre un mode d'essai avec un ensemble limité de fonctionnalités. 

Si vous disposez d'une licence Compositeur Digital, veuillez suivre la description ci-dessous pour vous connecter à partir de l'application. 

Vous pouvez également créer un compte [ici](http://www.compositeurdigital.com/Account/Register) ou [nous contacter](mailto:contact@excense.fr) pour acheter une licence.
...
![Activer le mode kiosque](../../en/img/administrative_kiosk_activation.JPG)
